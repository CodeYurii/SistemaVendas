...
type
  TFormPrincipal = class(TForm)
    ...
    SButtonGrupoContasFin: TSpeedButton;
    ...
    procedure SButtonGrupoContasFinClick(Sender: TObject);
...
procedure TFormPrincipal.SButtonGrupoContasFinClick(Sender: TObject);
begin
  FechaSubMenu(SButtonGrupoContasFin, PanelSubMenuFin);
end;
